...
build-linux-amd64:
	...
	@md5 "dist/${NAME}-Linux-x86_64" >> "dist/${NAME}-md5sum.txt"
...
build-linux-arm64:
	...
	@md5 "dist/${NAME}-Linux-aarch64" >> "dist/${NAME}-md5sum.txt"
...
build-linux-armv7:
	...
	@md5 "dist/${NAME}-Linux-armv7l" >> "dist/${NAME}-md5sum.txt"
...
build-darwin-amd64:
	...
	@md5 "dist/${NAME}-Darwin-x86_64" >> "dist/${NAME}-md5sum.txt"
...
build-darwin-arm64:
	...
	@md5 "dist/${NAME}-Darwin-arm64" >> "dist/${NAME}-md5sum.txt"
